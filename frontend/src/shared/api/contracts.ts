...
export interface NexusApi {
  ...
  getAlerts(): Promise<NexusAlert[]>;
  getSetupHistory(): Promise<SetupHistoryItem[]>;
  getReplaySession(sessionId?: string): Promise<ReplaySession | null>;
  sendFeedback(payload: FeedbackPayload): Promise<ApiMutationResult>;
  sendSetupFeedback(payload: SetupFeedback): Promise<ApiMutationResult>;
}
