...
test('requires a departure after the causal boundary before counting a fresh return', () => {
  const result = detectTouchEpisodes(resistanceTarget, [
    ...resistancePrefix,
    candle(2, 98, 100.5, 97.5, 99.5),
    candle(3, 98, 98.2, 96, 97),
    candle(4, 98, 100.3, 97.8, 99.2),
    candle(5, 98, 98.2, 96, 97),
    candle(6, 98, 100.2, 97.8, 99.1),
    candle(7, 98, 98.2, 96, 97),
  ], {
    ...options,
    minBarsBetweenEpisodes: 0,
    scanFromCandleIndex: 2,
    requireFreshReturnBeforeFirstEpisode: true,
  });
